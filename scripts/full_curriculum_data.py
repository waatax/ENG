"""
full_curriculum_data.py
Complete high-density curriculum data for all 7 Grade bands (G6 to G12).
Includes:
- Concepts with formulas
- Phonics & Vocabulary with IPA
- Dual Dialogues with translations
- Multimodal reading passages with strategies
- Step 0 Thinking protocols
- Formative quizzes with scaffolded hints
- Fatal traps with explanations
- Pre-exam checklists
"""
                ...
                "units": [
                    ...
                    },
                    {
                        ...
                        "dialogue": [
                            ...
                            { "speaker": "Leo", "en": "Try to guess its meaning using context clues and keep reading!", "zh": "嘗試利用上下文線索猜測詞意，並保持閱讀節奏！" }
                        ],
                        "reading": {
                    ...
                    },
                    {
                        ...
                        "dialogue": [
                            ...
                            { "speaker": "Alex", "en": "Mount Jade is higher! It stands at 3,952 meters, taller than Mount Fuji.", "zh": "玉山比較高！它有 3,952 公尺，比富士山高。" }
                        ],
                        "reading": {
...
print("full_curriculum_data.py initialized.")
